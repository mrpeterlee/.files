...
"
" Default .vimrc location for Neovim:
...
" Type :WipeReg to clear all registers (see
...
call plug#begin('~/.config/nvim/plugged')
	...
	" Git tools
	" Plug 'airblade/vim-gitgutter'  " Does not seem to work with MacOS
    ...
    Plug 'junegunn/vim-easy-align'  " Vim Tables
    ...
    Plug 'inside/vim-search-pulse'  " search and pulse the pattern
    Plug 'RRethy/vim-illuminate' " provide highlighting for the word under cursor

	" Color schemes
	Plug 'gerardbm/vim-atomic'
    Plug 'flazz/vim-colorschemes' " one-stop for all colors

	" Wordpress Blog
	Plug 'mrpeterlee/VimWordpress'

    " Tmux Vim Clipboard - to share the common clipboard
...
" omnisharp-vim
" Open vim to a .cs file and install the stdio server with :OmniSharpInstall. Restart vim and feel the difference!
let g:OmniSharp_server_stdio = 0  " use asynchronous server interactions
let g:OmniSharp_selector_ui = 'ctrlp'  " Use ctrlp.vim
let g:OmniSharp_highlight_types = 3

" search_pulse
let g:vim_search_pulse_mode = 'cursor_line'  "pulse the word and line in search results
...
" Disable Jedi-vim autocompletion and enable call-signatures options and use
" ncm2 for these features
...
" [deprecated] let g:deoplete#omni#functions    = {}
let g:deoplete#custom#var = {}
call deoplete#custom#option('auto_complete_delay', 250)
" [deprecated] let g:deoplete#enable_smart_case = 1
...
" Use Ag to replace ack
" Linux: apt-get install silversearcher-ag
" Mac: apt-get install silversearcher-ag
let g:ackprg = 'ag --nogroup --nocolor --column'
" The below has the same effect but will report every match on the line.
