...
wt -p "WSL" --window "useExisting" --launchMode "maximized" --startingDirectory "D:\lab" cmd /k "ubuntu.exe"
wt new-tab -p "WSL" --window "useExisting" --launchMode "maximized" --startingDirectory "D:\lab" cmd /k "ubuntu.exe"
