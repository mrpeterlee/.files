...
validate_env() {
    ...
    local -a env_cli_tools=(codex pnpm wrangler infisical gh kubectl argocd helm aliyun aws az bat rg fzf zoxide delta eza lazygit nvim yazi sesh twm oh-my-posh)
